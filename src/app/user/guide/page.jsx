...
const FAQ_ITEMS = [
  {
    ...
    answer: "Klik tombol 'Buat Laporan Baru' di dashboard atau menu samping. Isi formulir dengan lengkap termasuk judul, kategori, dan deskripsi. Tambahkan lampiran jika diperlukan."
  },
  {
    question: "Berapa lama laporan akan ditanggapi?",
    answer: "Laporan biasanya ditanggapi dalam 1-3 hari kerja. Untuk laporan mendesak, tanggapan diberikan dalam 24 jam."
  },
  {
    question: "Bagaimana cara mengaktifkan laporan anonim?",
    answer: "Saat membuat laporan, centang opsi 'Sembunyikan identitas saya' di bagian bawah formulir."
  }
];
